...
pacman::p_load("ggplot2", "tidyverse", "dplyr", "data.table")

# start of project code 
income.use = read.csv("Refrig vs Non (Income).csv", header=TRUE)
recs2015 = read.csv("https://www.eia.gov/consumption/residential/data/2015/csv/recs2015_public_v1.csv")
